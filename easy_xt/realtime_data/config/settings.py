...
class RealtimeDataConfig:
    ...
    DEFAULT_CONFIG = {
        ...
        "websocket": {
            ...
            "recovery_ttl": 300,
            "recovery_max_sessions": 10000,
            "recovery_cache_size": 2000,
            "recovery_cache_window": 30
        },
        "scheduler": {
            "update_interval": 3,
            "batch_size": 50
        ...
        "dashboard": {
            ...
            "enable_cors": True,
            "ui": {
                "source_scroll_release_delay_ms": 200
            }
        },
        "logging": {
            "level": "INFO",
    ...
    def get_source_routing_config(self) -> dict[str, Any]:
        return self.config.get("source_routing", {})
