...
from .cache_strategy import CacheConfig, CacheStrategy, CacheType, CacheKeyBuilder, CacheMetrics
from .memory_cache import MemoryCache

RedisCache: Optional[Any] = None
REDIS_AVAILABLE = False
try:
    from .redis_cache import RedisCache as _RedisCache, REDIS_AVAILABLE as _REDIS_AVAILABLE
