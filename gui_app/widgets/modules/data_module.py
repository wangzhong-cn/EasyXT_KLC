...
class DataModule(QWidget):
    def __init__(self, parent=None):
        ...
        self._factories = [
            ("数据治理", "gui_app.widgets.data_governance_panel", "DataGovernancePanel"),
            ("本地数据管理", "gui_app.widgets.local_data_manager_widget", "LocalDataManagerWidget"),
            ("高级数据查看", "gui_app.widgets.advanced_data_viewer_widget", "AdvancedDataViewerWidget"),
        ]
